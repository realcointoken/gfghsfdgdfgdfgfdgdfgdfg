...
const NftProgress = () => {
  ...
  const secondsRemaining = (endBlockNumber - currentBlock) * PLS_SECONDS_TIME
  ...
  return (
    <Card>
      <CardBody>
        ...
        <InfoRow>
          ...
          <div>
            {!isInitialized ? (
              ...
              <Link href={`https://scan.pulsechain.com/block/${endBlockNumber}`} target="_blank" rel="noreferrer noopener">
        ...
        <Message>{TranslateString(999, 'NFTs can be traded in for CARROT until the above block height')}</Message>
      </CardBody>
    </Card>
  )
}
